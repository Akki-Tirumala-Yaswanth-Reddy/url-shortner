...
| v4 | ✅ Done | PostgreSQL + Redis | Click tracking, stats API, health & readiness probes | [v4 README](./v4/README.md) |
...
- `v4/` - Fourth implementation (click tracking, stats API, health & readiness probes)
