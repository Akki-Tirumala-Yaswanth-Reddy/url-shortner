...
| v4 | ✅ Done | PostgreSQL + Redis | Click analytics, per-link stats API, health/readiness endpoints | [v4 README](./v4/README.md) |
...
- `v4/` - Fourth implementation (click analytics, per-link stats API, health/readiness endpoints)
