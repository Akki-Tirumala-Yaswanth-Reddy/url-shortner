...
| v4 | ✅ Done | PostgreSQL + Redis | Click tracking, stats API, health/readiness endpoints | [v4 README](./v4/README.md) |
...
- `v4/` - Fourth implementation (click tracking, stats API, health/readiness endpoints)

## Roadmap

- v5: rate limiting, TTL / link expiry, per-day analytics
